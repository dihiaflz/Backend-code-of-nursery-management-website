...
const psychoRouter = express.Router();
const Comment = require("../models/PsychoComment")
const Enfants = require("../models/Enfants")
const authMiddleware = require("../authMiddleware")

// afficher tous les enfants
psychoRouter.get("/", authMiddleware, async (req, res) => {
...
psychoRouter.get("/commentaires", authMiddleware, async (req, res) => {
...
psychoRouter.get("/:id", authMiddleware, async(req, res) => {
    try{
...
psychoRouter.post("/:id", authMiddleware, async(req, res) => {
    try {
    const enfant = await Enfants.findById(req.params.id)
